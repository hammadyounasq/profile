      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center justify-items-start">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              I started my web development journey a few six months ago and have
              been continuously learning and evolving ever since. Over time,
              I’ve worked on scalable web applications, admin panels, and SaaS
